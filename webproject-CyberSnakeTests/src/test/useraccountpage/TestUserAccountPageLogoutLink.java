...
public class TestUserAccountPageLogoutLink {
  ...
  @Test
  public void testUserAccountPageLogoutLink() throws Exception {
	...
	assertEquals(driver.getCurrentUrl(), ("http://elopezbanderas4830.ddns.net:8080/webproject-CyberSnake/Logout"));
    Thread.sleep(3000);
